      ...
      <section className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black">
        <div className="container-max section-padding">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-snug">
            Have a concern or an idea that needs attention? 
            Reach out to TaskForce — your campus helpline for social initiatives.
            </p>
          </div>
        </div>
      </section>
